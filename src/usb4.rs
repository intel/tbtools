...
pub const TMU_RTR_CS_3_TS_PACKET_INTERVAL_MASK: u32 = genmask_t!(u32, 31, 16);

pub const TMU_RTR_CS_15_FREQ_AVG_MASK: u32 = genmask_t!(u32, 5, 0);
pub const TMU_RTR_CS_15_DELAY_AVG_MASK: u32 = genmask_t!(u32, 11, 6);
pub const TMU_RTR_CS_15_DELAY_AVG_SHIFT: u32 = 6;
pub const TMU_RTR_CS_15_OFFSET_AVG_MASK: u32 = genmask_t!(u32, 17, 12);
pub const TMU_RTR_CS_15_OFFSET_AVG_SHIFT: u32 = 12;
pub const TMU_RTR_CS_15_ERROR_AVG_MASK: u32 = genmask_t!(u32, 23, 18);
pub const TMU_RTR_CS_15_ERROR_AVG_SHIFT: u32 = 18;

pub const TMU_RTR_CS_18_DELTA_AVG_MASK: u32 = genmask_t!(u32, 23, 16);
...
pub const ADP_CS_2_TYPE_MASK: u32 = genmask_t!(u32, 23, 0);
...
pub const LANE_ADP_CS_1_ADAPTER_STATE_MASK: u32 = genmask_t!(u32, 29, 26);
...
pub const PATH_CS_0_OUT_HOP_MASK: u32 = genmask_t!(u32, 6, 0);
pub const PATH_CS_0_OUT_ADAPTER_MASK: u32 = genmask_t!(u32, 16, 11);
